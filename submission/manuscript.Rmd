...
plot(x = roc(response = dat_summary$type,
             predictor = dat_summary$fish_combine_3_hetero_p,
             percent = TRUE,
             ci = TRUE,
             of = 'se',
...
plot(x = roc(response = dat_summary$type,
             predictor = dat_summary$variance_sd_p_overall_homo,
             percent = TRUE,
             ci = TRUE,
             of = 'se',
             sp = seq(0, 100, 5)), ci.type="shape")
...
{
  plot(x = roc(response = dat_summary$type,
               predictor = dat_summary[, i],
               percent = TRUE,
               ci = TRUE,
               of = 'se',
               sp = seq(0, 100, 5)), ci.type="shape", main = names(dat_summary)[i])
}

plot(fpr[,1], tpr[,1], type = 's')
lines(fpr[,6], tpr[,6], type = 's')
...
plot(x = roc(response = dat_summary$type,
             ...
             ci = TRUE,
             of = 'se',
             sp = seq(0, 100, 5)), ci.type="shape", main = 'homogeneous')
plot(x = fpr$variance_sd_p_overall_homo, y = tpr$variance_sd_p_overall_homo, type = 's')

plot(x = roc(response = dat_summary$type,
             predictor = dat_summary$variance_sd_p_overall_hetero,
             percent = TRUE,
             ci = TRUE,
             of = 'se',
             sp = seq(0, 100, 5)), ci.type="shape", main = 'homogeneous')
plot(x = fpr$variance_sd_p_overall_hetero, y = tpr$variance_sd_p_overall_hetero, type = 's')
```
