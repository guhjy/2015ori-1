...
The application of such statistical methods to detect data fabrication has occurred in several cases of scientific misconduct in recent years and has potential for future application beyond these specific cases. 
...
Nonetheless, prior to applying statistical methods to flag potentially problematic results, investigating whether such methods function well enough in detecting problems is required for responsible application. 
