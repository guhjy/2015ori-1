...
{
  tp[i] <- sum(dat_summary$fish_combine_6_p < threshold & dat_summary$type == 'qualtrics', na.rm = TRUE)
  fp[i] <- sum(dat_summary$fish_combine_6_p < threshold & dat_summary$type == 'ml', na.rm = TRUE)
  fn[i] <- sum(dat_summary$fish_combine_6_p > threshold & dat_summary$type == 'qualtrics', na.rm = TRUE)
  tn[i] <- sum(dat_summary$fish_combine_6_p > threshold & dat_summary$type == 'ml', na.rm = TRUE)
